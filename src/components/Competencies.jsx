...
import { competencies, toolkit } from "../data/content";
...
export const Competencies = () => {
  ...
  return (
    <Section
      ...
      intro="An honest self-assessment. Technical depth and written communication are where I'm strongest; go-to-market is where I have the most to learn."
    >

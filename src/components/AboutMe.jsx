...
export const AboutMe = () => {
  const skillIcons = [js, ml, css, figma, md, next, node, py, react, tailwind];
  return (
    <>
        ...
        <div className="w-full px-3 max-w-[60rem] h-full">
          ...
          <div className="Me h-screen relative flex max-md:flex-col items-center py-5 md:mt-20">
            ...
            <div className="AboutMeText p-5 flex flex-col mt-5 gap-y-3 md:w-1/2">
              ...
              >
                Hi, I&apos;m Sushant! I&apos;m a Technical Product Manager currently interning at Devtron, backed by a Computer Science and Engineering foundation from VIT. I like turning messy technical constraints into clear, shippable roadmaps — from optimizing large-scale data querying performance by 25% to shipping B2B SaaS features end-to-end. My edge is speaking both PRD and API: I can read a system design doc and still write a roadmap the whole team can rally behind.
              </motion.div>
          ...
          <div className="h-screen flex max-md:flex-col md:items-center gap-5">
            <div className="flex flex-col md:w-1/2 h-3/4">
              <div className="flex flex-col justify-center p-5 max-md:items-center">
                ...
                >
                  I bridge engineering and strategy — using data, user
                  research, and technical fluency to turn ambiguous problems
                  into roadmaps that actually ship.
                </motion.div>
              </div>
